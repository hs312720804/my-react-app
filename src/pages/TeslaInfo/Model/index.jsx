...
const Model = (props) => {
  ...
  // console.log('1-loaction---->', state)
  // console.log('2-loaction---->', useParams())
  // const [search, setsearch] = useSearchParams()
  // console.log('3-loaction---->', search.get('name'))
  // console.log('4-loaction---->', search.get('age'))

  const { configuration, color, mode, name, price } = state
  let [wheelIndex, setWheelIndex] = useState(0)
  let [colorIndex, setCarColorIndex] = useState(0)
